...
// const ProfilePage = ({ userRole, username, onLogout, onBackToDashboard }) => {
      ...
      <div className="dashboard-wrapper">
        ...
        <div className="dashboard-container">
          <Sidebar 
            ...
            onSearchToggle={() => {}} // Empty function since Profile page doesn't need search
          />
